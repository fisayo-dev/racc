...
const VoteLists = () => {
    const fakeVotingList = [
        ...
        },
        {
          ...
          description: "Who is the most influential tech entrepreneur of the century?",
          voters: [8, 12, 15],
          status: "ongoing",
        ...
        },
        {
          ...
          description: "Should humanity prioritize space exploration over Earth conservation?",
          voters: [17, 22, 30],
          status: "upcoming",
