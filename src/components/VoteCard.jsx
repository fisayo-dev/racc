...
const VoteCard = ({
  ...
  return (
    <div className="bg-zinc-800 h-[520px] md:h-[440px] overflow-hidden text-zinc-100 border-[0.1rem] border-zinc-800 hover:border-zinc-500 cursor-pointer shadow-md rounded-lg grid gap-2">
