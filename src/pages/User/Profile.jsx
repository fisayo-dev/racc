...
import { BarChart, BarChart2Icon, Barcode } from "lucide-react";
            ...
            <div className="w-full bg-zinc-800 rounded-lg p-6">
              <div className="grid gap-2">
                ...
                <div className="grid gap-5 my-5 grid-cols-1 md:grid-cols-3">
                  <div className="grid place-items-center items-center bg-zinc-700 h-64 shadow rounded-lg p-6">
                  ...
                  <div className="bg-zinc-700 h-64 shadow rounded-lg p-6"></div>
                  <div className="bg-zinc-700 h-64 shadow rounded-lg p-6"></div>
                </div>
              </div>
            </div>
