  ...
  return (
    <div>
      ...
      <div className="app-container my-[8rem] grid gap-10">
        ...
        <div className="grid gap-3 mx-auto 2xl:w-3/5 md:w-4/6">
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <p>{backgroundImage ? "Change the image" : "Upload an image"}</p>
            </div>
          </div>
          <div className="grid gap-4">
          ...
          <div className="grid gap-4">
            <h2 className="text-md">What date do you want the vote to end?</h2>
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant={"outline"}
        ...
        {loading && <Loader2Icon className="animate-spin h-32 w-32 mx-auto" />}
        <div
          onClick={editVote}
